...
![](p8105_hw6_ar4040_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](p8105_hw6_ar4040_files/figure-gfm/unnamed-chunk-12-2.png)<!-- -->

It is clear that both the r-squred estimates as well as the
log(intercept\*slope) estimates follow an approximately normal
distribution.

Now we need to compute a 95% confidence interval for both the
estimates..
...
```
    ...
    ##   <chr>        <dbl>    <dbl>
    ## 1 r_squared    0.894    0.927

The 95% confidence interval for the R Squared values is (0.894,0.927)
for this bootstrap run (changes every time the dataframe is created)
...
```
    ...
    ##   term                   ci_lower ci_upper
    ##   <chr>                     <dbl>    <dbl>
    ## 1 log_estimate_intercept     1.97     2.06

The 95% confidence interval for the log of slope times intercept is
(1.964,2.057) for this bootstrap run.
